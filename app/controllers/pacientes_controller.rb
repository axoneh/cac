class PacientesController < ApplicationController
  ...
  private
    ...
    def paciente_params
      params.require(:paciente).permit(:identificacion, :nombre, :apellido, :genero, :direccion, :estado, :fechaNacimiento, :patologia_id, :tipo_documentos_id, :estado_civils_id)
    end
end
