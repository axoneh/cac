class CuentaUsuariosController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to cuenta_usuarios_url, notice: 'Cuenta usuario was successfully destroyed.' }
  ...
  private
    ...
    def cuenta_usuario_params
      params.require(:cuenta_usuario).permit(:identificacion, :nombre, :apellido, :rol, :genero, :fechaNacimiento, :direccion, :estado, :tipo_documentos_id, :estado_civils_id)
    end
end
