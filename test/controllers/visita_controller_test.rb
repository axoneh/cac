...
class VisitaControllerTest < ActionController::TestCase
  ...
  test "should create visitum" do
    assert_difference('Visitum.count') do
      post :create, visitum: { InrDomicilio: @visitum.InrDomicilio, observacion: @visitum.observacion, pacientes_id: @visitum.pacientes_id }
    end
  ...
  test "should update visitum" do
    patch :update, id: @visitum, visitum: { InrDomicilio: @visitum.InrDomicilio, observacion: @visitum.observacion, pacientes_id: @visitum.pacientes_id }
    assert_redirected_to visitum_path(assigns(:visitum))
  end
